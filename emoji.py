...
def show_subject():      
    ...
    bounding_box = cv2.CascadeClassifier('C:/Users/ranje/AppData/Local/Programs/Python/Python39/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
